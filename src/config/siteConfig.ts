...
export const siteConfig: SiteConfig = {
	title: "H2RO Archive",
	subtitle: "我的生活与学习档案",
	siteURL: "https://h2ro.cn/", // 部署前替换为正式站点 URL，以斜杠结尾
	siteStartDate: "2026-07-06", // 站点开始运行日期，用于站点统计组件计算运行天数

	lang: SITE_LANG,

	themeColor: {
		hue: 34, // 纸墨基线使用暖纸色相，后续如需品牌色再集中调整。
	...
	bangumi: {
		userId: "964582", // Bangumi 用户 ID
		fetchOnDev: true, // 开发环境下读取已生成的 Bangumi 数据，便于本地预览
	},

	bilibili: {
		vmid: "", // 启用 Bilibili 模式前填写用户 ID (uid)
